...
\begin{proof}
    ...
    Since $x^2 \mid y^2$ implies $x \mid y$, it follows that $m^2 \mid (2n)^2$ which implies $m \mid 2n$ and thus $2n 
    = ms$ for some positive integer $s$. Substituting gives $m^2(5m+3)(3m+1) = m^2s^2$, hence
    \[
    (5m+3)(3m+1) = s^2
    \]
