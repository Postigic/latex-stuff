...
\begin{claim}
    ...
    $\mathbb{R}^2$, then it is a linear transformation, and its matrix representation is 
    \[
    \begin{bmatrix}
        2 & -1 \\
        1 & -3
...
\begin{proof}
    ...
    $\mathbb{C}$ as the real vector space $\mathbb{R}^2$, then it is a linear transformation with matrix 
    representation 
    \[
    \begin{bmatrix}
        2 & -1 \\
