...
\begin{proof}
    By definition of the GSeries, the Sox must win $n + 1$ games to win the series. Let the Cards win
    $i$ games, where $0 \leq i \leq r$. Then the Sox have exactly $i$ losses. Hence, the series lasts 
    for
    \[
    n + i + 1
    \]
    ...
    append the remaining $r - i$ $0$s after the final $1$. Thus the sequence consists of exactly 
    $n + 1$ $1$s and $r$ $0$s.
